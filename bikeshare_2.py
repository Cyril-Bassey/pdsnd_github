...
def user_stats(df):
    ...
    if 'Gender' not in df:
        print('Oops!!!, no gender data for this city :(')  
    else:
    ...
    if 'Birth Year' not in df:
        print('Oops, The data related to birth year of users is not available for this city.')
    else:
...
def display_data(df):  
    ...
    for i in range(0, row_length, 5):
        ...
        print('Hey! please do enter a valid choice. Let\'s try that again. ')
        return
